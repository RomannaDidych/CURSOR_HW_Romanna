export const buttonArr = Array.from(document.querySelectorAll(".button"));
export const melodyArr = Array.from(document.querySelectorAll(".melody"));
...
export function connectBtnWithAudio() {
  stopAudio();
  removeActive();
...
export function connectPressedBtnWithAudio(e) {
